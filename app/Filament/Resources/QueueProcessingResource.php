...
use App\Filament\Resources\QueueProcessingResource\Pages;
...
class QueueProcessingResource extends Resource
{
    protected static ?string $model = Transaction::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $pluralModelLabel = 'Antrian Proses';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                // Aksi untuk menyelesaikan cuci (dari proses ke selesai)
                Action::make('finish_processing')
                    ->label('Selesai')
                    ->icon('heroicon-o-check-circle')
                    ->color('success')
                    ->visible(fn(Transaction $record): bool => $record->status === 'proses')
                    ->requiresConfirmation()
                    ->modalHeading('Selesaikan Cucian')
                    ->modalDescription('Apakah Anda yakin cucian kendaraan ini sudah selesai?')
                    ...
                    ->action(function (Transaction $record): void {
                        ...
                        Notification::make()
                            ->title('Berhasil!')
                            ->body('Cucian kendaraan telah selesai dan siap diambil pelanggan')
                            ->success()
                            ->send();
                    }),
            ])
