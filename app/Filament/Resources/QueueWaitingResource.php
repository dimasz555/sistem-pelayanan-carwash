...
use App\Filament\Resources\QueueWaitingResource\Pages;
use App\Filament\Resources\QueueWaitingResource\RelationManagers;
use App\Models\QueueWaiting;
...
class QueueWaitingResource extends Resource
{
    protected static ?string $model = Transaction::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $pluralModelLabel = 'Antrian Menunggu';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                // Aksi untuk memulai proses cuci (dari menunggu ke proses)
                Action::make('start_processing')
                    ->label('Mulai Proses')
                    ->icon('heroicon-o-play')
                    ->color('info')
                    ->visible(fn(Transaction $record): bool => $record->status === 'menunggu')
                    ->requiresConfirmation()
                    ->modalHeading('Mulai Memproses Cucian')
                    ->modalDescription('Apakah Anda yakin ingin memulai memproses cucian kendaraan ini?')
